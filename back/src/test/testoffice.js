...
async function generateData(x) {
  ...
  const typeofheating = ["Boilers", "Fireplaces", "Heat Pumps", "Electric Space Heaters"]; 
  const energyefficiency = ["A", "B", "C", "D"]; //0-3
  const yearofbuilt = [1998, 1950, 1994, 1960, 2007, 1988, 1990, 2011, 2012, 2015, 2017, 1965];
  const renovationyear = [2010, 2015, 2014, 2016, 2007, 2018, 2019, 2011, 2012, 2015, 2017, 2013];//0-11
  ...
  for (let index = 0; index < x; index++) {
    ...
    const post = new Office({
      ...
      additional:{
        ...
        forpeoplewithmobilityproblems: forpeoplewithmobilityproblems[between(0, 1)],
